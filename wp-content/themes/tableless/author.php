...
<div class="tb-container">
  ...
  <div class="tb-post-author">
    ...
    <p class="tb-lead-paragraph tb-divider"><?php the_author_meta('description'); ?> <a href="http://twitter.com/<?php the_author_meta('twitter'); ?>" class="tb-twitter-lnk">@<?php the_author_meta('twitter'); ?></a></p>
  </div>
